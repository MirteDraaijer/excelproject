...
ui <- fluidPage(
  ...
  tabsetPanel(
    tabPanel("Welkom",
    wellPanel(
      style = "background-color:#E8E8E8; padding:40px; text-align:center;",
      h1("Welkom bij de MM-curve fitting app", style = "color:#2C3E50; font-weight:700"),
      p("Visualiseer en fit jouw data!", style = "color:#2C3E50; font-size:16px;")
    ),
    wellPanel(
      style = "background-color:#FAFAFA;",
      h4("Wat kun je doen?"),
      tags$ul(
        tags$li("Fit een enkele MM-curve"),
        tags$li("Fit een dubbele MM-curve"),
        tags$li("Fit een enkele MM-curve met substraatinhibitie")
        )
      )
    ),
