...
Ik heb ook nog een Excel-sheet ontvangen over substraat inhibitie. Dit wil ik ook toevoegen aan de applicatie. Ik zal eerst een kleine exploratieve analyse doen voordat ik dit toevoeg aan de applicatie.
...
ggplot(plot_data, aes(x = concentration, y = activity)) +
  ...
  theme(plot.title = element_text(hjust = 0.5))
```
De figuur heeft nog een legenda nodig en de substraat inhibitie staat nog niet in een functie maar dat is zo gebeurt. De substraat inhibitie lijkt in elk geval te werken.
